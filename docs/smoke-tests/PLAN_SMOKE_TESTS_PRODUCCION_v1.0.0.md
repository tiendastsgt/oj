...
+- ?? SMOKE-1 FAIL ? ROLLBACK inmediato
+- ?? SMOKE-2 FAIL ? ROLLBACK inmediato
+- ?? SMOKE-7 FAIL ? ROLLBACK inmediato
...
## Recomendación
?? **PROCEDER CON TRÁFICO AL 100%** o ?? **MONITOREAR CON CAUTELA** o ?? **ROLLBACK**
